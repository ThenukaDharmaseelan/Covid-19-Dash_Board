...
def get_page_heading_style():
    return {'backgroundColor': colors['backround']}
...
# Generate CARDS for ovrall numbers
...
def get_slider():
    return html.Div([
         ...
         html.Div([html.Label('Select Moving Avereage Window')],id='my-div'+ str(id),style={'textAlign':'center'})
    ])
